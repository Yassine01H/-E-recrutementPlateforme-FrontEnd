...
const PostNewJob =(props)=>{
 ...
 // console.log("Employer"+props.IdEmployer);
return (
<>
<Header/>
    ...
    <div className="container">
      <div className="row justify-content-center">
        ...
        <div className="col-md-8">
          <div className=" justify-content-center">
            <ul className="nav nav-tabs nav-tabs-03 justify-content-center d-sm-flex d-block text-center" id="myTab" role="tablist">
              ...
              <li className="flex-fill">
              <Link className="nav-item"  aria-selected="false">
        ...
        <div className="tab-content" id="myTabContent">
          <div className="tab-pane fade active show" id="Job-detail" role="tabpanel" aria-labelledby="Job-detail-tab">
            <section className="space-ptb">
              <div className="container">
                    <NewJobForm IdEmployer={props.IdEmployer} />
                    
              </div>
            </section>
          </div>
          <div className="tab-pane fade show" id="Package" role="tabpanel" aria-labelledby="Package-tab">
            <section className="space-ptb">
              <div className="container">
                <div className="row">
                  <div className="col-12">
                      ...
                      <table className="table table-striped mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div className="custom-control custom-checkbox">
                                <input type="checkbox" className="custom-control-input" id="pachage-01" />
                                <label className="custom-control-label" htmlFor="pachage-01" />
                              </div>
                            </td>
                            <th>Golden</th>
                            <td>$90.00</td>
                          ...
                          <tr>
                            <td>
                              <div className="custom-control custom-checkbox">
                                <input type="checkbox" className="custom-control-input" id="pachage-02" />
                                <label className="custom-control-label" htmlFor="pachage-02" />
                              </div>
                            </td>
                            <th>Premium</th>
                            <td>$159.00</td>
                          ...
                          <tr>
                            <td>
                              <div className="custom-control custom-checkbox">
                                <input type="checkbox" className="custom-control-input" id="pachage-03" />
                                <label className="custom-control-label" htmlFor="pachage-03" />
                              </div>
                            </td>
                            <th>Silver</th>
                            <td>$50.00</td>
                          ...
                          <tr>
                            <td>
                              <div className="custom-control custom-checkbox">
                                <input type="checkbox" className="custom-control-input" id="pachage-04" />
                                <label className="custom-control-label" htmlFor="pachage-04" />
                              </div>
                            </td>
                            <th>Standard</th>
                            <td>Free</td>
